...
if sym_type == "robot"
    ...
    helper.my_plot_robot(params.t, [params.controller.y_ref(1:4,:) repmat(params.controller.y_ref(1:4,end),1,(abs(length(params.x_S) - length(params.controller.y_ref))))], params.x_S, params.y_S, params.theta_S, params.S_p_y, params.u_n, params.u_t);
else
    helper.my_plot(params.t, [params.controller.y_ref(1:3,:); params.controller.y_ref(4,:)], params.x_S, params.y_S, params.theta_S, params.S_p_y, params.u_n, params.u_t, params.controller.cost_function_vect);%, helper.convert_str2num(params.mode_vect));
end
